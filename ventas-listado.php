...
<body id="page-top">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col">
      <a href="venta-formulario.php" class="btn btn-primary btn-md mr-2 mb-4">Nuevo</a>
      </div>
    </div>
    <table class="table table-hover border">
      ...
      <?php foreach($aVentas as $venta):?>
        <tr>
          ...
          <td class="text-right"><a href="venta-formulario.php?id=<?php echo $venta->idventa;?>"><i class="fas fa-search"></i></a></td>
        </tr>
      <?php endforeach; ?>
    </table>
  </div>
